...
### Автор: 
[Danil Mordovin](https://github.com/Mordovin/)
...
[![Node.js](https://img.shields.io/badge/-Node.js-464646?style=flat&logo=Node.js&logoColor=56C0C0&color=cd5c5c)](https://nodejs.org/)
[![Git](https://img.shields.io/badge/-Git-464646?style=flat&logo=Git&logoColor=56C0C0&color=0095b6)](https://git-scm.com/)
[![React](https://img.shields.io/badge/-React-464646?style=flat&logo=React&logoColor=56C0C0&color=cd5c5c)](https://reactjs.org/)
...
```
git clone https://github.com/Mordovin/taski-docker.git
```
...
sudo ufw status
```
Запустите сборку фронтенд-приложения из директории tasking-docker/frontend/
```
npm run build
```
...
```
sudo cp -r /home/yc-user/tasking-docker/frontend/build/. /var/www/taski/
```
